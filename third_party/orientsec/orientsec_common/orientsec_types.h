...
#define ORIENTSEC_GRPC_PROVIDER_FLAG_CALL_FAIlOVER 1     //调用出错，多次调用出错设置本标记
//#define ORIENTSEC_GRPC_PROVIDER_FLAG_NOT_ACCESSED_BY_OLD_CLIENT 3  //新服务上线，新服务不被旧客户端调用
